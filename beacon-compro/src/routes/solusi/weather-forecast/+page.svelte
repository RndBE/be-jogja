		...
		<div class="grid md:grid-cols-2 gap-8">
			{#each products as product}
				...
				>
					...
					<div
						class="relative z-10 m-4 p-7 rounded-[22px] transition-all duration-500 transform group-hover:-translate-y-1"
					...
					>
						<div class="flex items-center gap-4 mb-5">
							...
							<div>
								<span
									class="font-heading text-xl font-bold text-white tracking-tight"
									>{product.name}</span
								>
								<span
									class="block text-[10px] uppercase tracking-widest text-white/50 mt-0.5"
									>{product.full}</span
								>
							</div>
						</div>
						...
						<div
							class="flex items-center gap-2 text-sm font-semibold text-[#818CF8] group-hover:gap-3 transition-all mt-4"
						>
	...
	<div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
		<div class="max-w-xl">
			<h2
				...
				style="color: #1A1A1A;"
			>
				Butuh Stasiun Cuaca untuk Proyek Anda?
			</h2>
			<p class="text-sm mb-8" style="color: #5C5C5C;">
				Tim kami siap membantu dari perencanaan sampai operasional.
			</p>
			<a
				href="https://wa.me/628112850986?text=Halo%20Beacon%2C%20saya%20tertarik%20dengan%20solusi%20Weather%20Forecast."
				target="_blank"
				rel="noopener"
