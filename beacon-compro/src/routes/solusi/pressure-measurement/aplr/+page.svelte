...
<section class="relative py-16 lg:py-24 overflow-hidden" style="background: linear-gradient(180deg, #FAFAFA 0%, #ECFDF5 100%);">
	...
	<div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
		<div class="text-center mb-12">
			...
			<h2 class="font-heading text-3xl sm:text-4xl font-bold mt-3" style="color: #1A1A1A;">Mengapa APLR Beacon</h2>
		</div>
			...
			{#key activeVariant}
				<div class="grid lg:grid-cols-[1fr_1.2fr] gap-12 lg:gap-16 items-start animate-in fade-in slide-in-from-bottom-8 duration-500">
					...
					<div class="space-y-6 pt-4">
						...
						<ProductSpecs {variants} {activeVariant} accentColor="#059669" />
					</div>
				</div>
			{/key}
		</div>
	...
	<div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
		...
		<div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
			{#each projects as proj}
				<div class="p-5 rounded-2xl bg-[#FAFAFA] hover:bg-[#D1FAE5] transition-all" style="border: 1px solid #E5E5E5;">
