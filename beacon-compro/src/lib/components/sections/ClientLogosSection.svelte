...
<section id="logo-klien" class="relative py-24 lg:py-32 bg-white overflow-hidden">
	<Ornaments />
	...
	<div class="relative mb-4">
		<div class="absolute left-0 top-0 bottom-0 w-24 z-10" style="background: linear-gradient(90deg, white, transparent);"></div>
		<div class="absolute right-0 top-0 bottom-0 w-24 z-10" style="background: linear-gradient(270deg, white, transparent);"></div>
